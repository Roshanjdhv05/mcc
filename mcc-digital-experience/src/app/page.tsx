...
const testimonials = [
  { name: 'Dr. Hariharan Ramasubhramanian', course: 'BCOM (2006), MCOM (2008), AIR 26 – CA PE (I), AIR 50- CA PE (II)\nCA, US CMA (Gold Medalist),\nMBA (Harvard Business School)', quote: 'I spent my formative years at MCC and it provided excellent launchpad at an affordable cost. The highlight was the quality of students and the healthy competition among academically inclined students.', avatar: 'HR' },
  { name: 'CA Mandar Pramod Dixit', course: 'BCOM (2006), CA, CPA\nAIR -1 in All the three levels of CA examinations', quote: 'MCC has played a key role in my academic journey. It imbibed discipline, rigour, curiosity and learning aptitude. It shaped the speaker within me by giving me a platform for elocution competitions. It gave me friends for lifetime and some professors who remained the Guru forever for me. My father graduated from ML Dahanukar College of PTVA and I had a fortune of graduating from MCC, part of the same PTVA. So MCC shall always be special for me as an institution and a shaper of my life journey.', avatar: 'MD' },
  { name: 'CA Amey Joshi', course: 'BCOM – 2017\nMA (International Relations)- Johns Hopkins School of Advanced International Studies (SAIS)', quote: 'My time at MCC challenged me academically while genuinely investing in my professional trajectory through professors\' mentorship. The blend of rigor and mentorship is what makes MCC click! As a second generation MCCian (my mother is an alumna too), we have nothing but praise at home for the rigor and dedication that MCC faculty show in nurturing their students into becoming talented professionals!', avatar: 'AJ' },
  { name: 'CA Sreejesh Pillai', course: 'BCOM – 2018, MBA- IIM (A)', quote: 'MCC has always been more than just a college for so many of us. I still vividly remember the countless moments that shaped us: not just through academics, but through the lessons beyond the classroom and the memories we created with friends. MCC wasn’t merely a place of learning; it was a family, a home that gave us friendships, values, and experiences that will stay with us for a lifetime.', avatar: 'SP' },
  { name: 'CA Aishwarya Rajaraman', course: 'BCOM – 2018, MBA- IIM (A)', quote: 'I met some of the best people and teachers at MCC, who pushed me to aim high and were always there my side', avatar: 'AR' },
  { name: 'CA Rahul Yogesh Pai', course: 'BCOM- 2024\nAIR 40- CIA Inter', quote: 'Great place for continuing my education, with highly experienced faculty and a lot of support provided in my professional education', avatar: 'RP' },
  { name: 'CA Nidhi Savla', course: 'BCOM- 2025\nAIR 40 – AIR Inter', quote: 'My three years at MCC have been an integral part of my journey. The learning, guidance, and experiences I gained here shaped me both personally and professionally and contributed greatly to my journey towards becoming a Chartered Accountant.', avatar: 'NS' },
  { name: 'CA Parth Gupta', course: 'BCOM – 2021, MBA – IIM (B)', quote: 'My time at Mulund College of Commerce gave me a strong academic foundation and prepared me well for the next stage of my journey. The dedicated faculty, structured curriculum, and emphasis on discipline helped me build the knowledge and confidence needed to pursue higher education. I am grateful for the guidance and support I received from my professors throughout my time at the college. I am thankful to the faculty and institution for helping build a strong foundation for my future.', avatar: 'PG' },
  { name: 'Adv Shweta Marathe', course: 'BCOM – 2017, LLM (Criminal Law)\nAIR 17 – CS Foundation', quote: 'Today, when I look back after almost a decade at the journey and association with MCC and now being a part of a profession that demands consistency, hard work, and making through the challenges irrespective of the results, the realisation which comes to my mind is that the roots of these values, facing and sailing through the challenges, were set in this very institution. MCC taught me to be strong, and to lead a life not just for mere survival, but one that is worth living. Grateful!', avatar: 'SM' },
  { name: 'CA Bhushan Bakre', course: 'BCOM -2017', quote: 'Looking back at my time at Mulund College of Commerce, I realize that what truly sets MCC apart is its grounded, no-nonsense culture. As one of Mumbai’s premier commerce institutions, it doesn\'t rely on superficial flash; instead, it anchors its reputation on a rigorous focus on academics, discipline, and hard work. The college is a hub for great minds. (both within the faculty and the student body) I had the privilege of learning from dedicated, highly capable professors who pushed us to think critically, while being surrounded by a pool of students who set a high benchmark for excellence and guidance. From hours spent utilizing the excellent library resources to navigating competitive academic environments, MCC instills a relentless work ethic in its students. In the professional world, recruiters often rely heavily on the MCC name because they know an MCC student is a natural slogger as someone who is resilient, executes under pressure, and puts in the real work. I am incredibly proud to be an MCC alumnus!', avatar: 'BB' },
  { name: 'CA Rushabh Bhachawat', course: 'BCOM 2017', quote: 'One of the best colleges in Mumbai for commerce in the Central region. I truly admire my time at MCC.', avatar: 'RB' },
  { name: 'CS Rutuja Satam', course: 'BCOM -2017 , LLB\nAIR 5 – CS Foundation', quote: 'The studious environment pushed my ambitions; our incredible professors inspired us to strive for the best and being surrounded by driven and passionate peers made a difference.', avatar: 'RS' },
];
...
const illustriousAlumni = [
  ...
  { 
    name: 'Hariharan Ramasubramanian',
    course: 'BCOM',
    batch: 'Class of 2008',
    ...
    <div className="bg-white rounded-3xl border border-[#E2E8F0] shadow-sm p-4 md:p-6 overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl font-bold text-[#123B6D] font-[var(--font-heading)]">MCC's Calendar</h2>
        </div>
...
function useMarqueeScroll(speed: number = 1, direction: 'x' | 'y' = 'x', interactDelay: number = 1500) {
  ...
  useEffect(() => {
    ...
    const resumeScroll = () => { if (!isDragging) isHovered.current = false; };
    ...
    document.addEventListener('mouseup', onMouseLeaveDoc);
    ...
    return () => {
      ...
      document.removeEventListener('mouseup', onMouseLeaveDoc);
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 mb-5 flex flex-col">
        <p className={`text-white/90 text-[13px] leading-relaxed ${expanded ? '' : 'line-clamp-4'}`}>
          "{t.quote}"
        </p>
        {t.quote.length > 150 && (
          <button 
            onClick={() => setExpanded(!expanded)} 
            className="text-[#D4A017] text-[11px] mt-2 font-bold hover:underline self-start uppercase tracking-wider"
          >
            {expanded ? 'Read Less' : 'Read More'}
          </button>
        )}
      </div>
      <div className="flex items-center gap-3 mt-auto pt-4 border-t border-white/10 shrink-0">
        <div className="w-10 h-10 rounded-full bg-[#D4A017] flex items-center justify-center text-white font-bold shrink-0">
          {t.avatar}
        </div>
        <div className="flex flex-col">
          <p className="font-bold text-white text-[13px] leading-tight">{t.name}</p>
          <p className="text-white/70 text-[10px] whitespace-pre-wrap leading-snug mt-0.5">{t.course}</p>
        </div>
      </div>
    </motion.div>
  );
          ...
          <div className="flex flex-col lg:flex-row gap-5 items-stretch">
            ...
            <div className="flex-1 bg-white rounded-3xl border border-[#E2E8F0] shadow-sm overflow-hidden flex flex-col">
              ...
              <div className="overflow-hidden w-full group pb-5 px-2 flex-1 relative">
                {/* Left arrow */}
                {mergedCulturalEvents.length >= 1 && (
                  <button
                    onClick={() => { const el = culturalRef.current; if (el) el.scrollLeft -= 360; }}
                    className="absolute left-3 top-1/2 -translate-y-1/2 z-10 w-8 h-8 rounded-full bg-white/90 shadow-md border border-[#E2E8F0] flex items-center justify-center text-[#123B6D] hover:bg-[#123B6D] hover:text-white transition-all duration-200 opacity-0 group-hover:opacity-100"
                ...
                {mergedCulturalEvents.length >= 1 && (
                  <button
                    onClick={() => { const el = culturalRef.current; if (el) el.scrollLeft += 360; }}
                    className="absolute right-3 top-1/2 -translate-y-1/2 z-10 w-8 h-8 rounded-full bg-white/90 shadow-md border border-[#E2E8F0] flex items-center justify-center text-[#123B6D] hover:bg-[#123B6D] hover:text-white transition-all duration-200 opacity-0 group-hover:opacity-100"
                    aria-label="Scroll right"
                  >
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 18 15 12 9 6"/></svg>
                  </button>
                )}
                <div ref={culturalRef} className="flex gap-4 overflow-x-auto no-scrollbar w-full cursor-grab">
                  {(mergedCulturalEvents.length >= 2 ? [...mergedCulturalEvents, ...mergedCulturalEvents] : mergedCulturalEvents).map((ev, i) => (
                    <Link
                      key={i}
