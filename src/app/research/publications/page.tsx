...
import {
  BookOpen, Users, FileStack, Link as LinkIcon, ChevronRight, Loader2, Info, ExternalLink, Download
} from "lucide-react";
...
function PublicationsContent() {
  ...
  const handleSelect = (id: string) => {
    ...
    router.push(`/research/publications?tab=${id}`, { scroll: false });
  };
                    ...
                    return (
                      ...
                      >
                        ...
                        {activeTab === section.id && (
                          <ChevronRight
                            size={14}
                            className="text-[#123B6D] shrink-0"
                          />
                        )}
                      </button>
                    );
            ...
            >
              ...
              <div className="p-6 md:p-10 space-y-10">
                ...
                {activeTab === "journal-about" && (
                  <section>
                    <div className="flex items-center gap-2 text-[#123B6D] font-bold text-lg mb-4">
                      <Info size={20} /> About the Journal
                    </div>
                    <p className="text-gray-600 leading-relaxed text-base md:text-lg whitespace-pre-line mb-8">
                      The MCC Research Journal is a peer-reviewed, bi-annual academic journal dedicated to publishing high-quality research papers, review articles, and case studies across multidisciplinary domains. It serves as a platform for academicians, researchers, and students to disseminate their scholarly findings.
                    </p>
                    <div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
                       <h4 className="font-bold text-[#1E293B] mb-3">Key Information</h4>
                       <ul className="space-y-3 text-gray-600">
                         <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-[#D4A017]" /> <strong>Frequency:</strong> Bi-annual</li>
                         <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-[#D4A017]" /> <strong>Format:</strong> Print & Online</li>
                         <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-[#D4A017]" /> <strong>Peer Review:</strong> Double-blind</li>
                         <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-[#D4A017]" /> <strong>ISSN:</strong> XXXX-XXXX</li>
                       </ul>
                    </div>
                  </section>
                )}
                ...
                {activeTab === "journal-board" && (
                  <section>
                    <div className="flex items-center gap-2 text-[#123B6D] font-bold text-lg mb-4">
                      <Users size={20} /> Board of Editors
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="bg-[#F8FAFC] border border-gray-100 rounded-xl px-6 py-5">
                         <p className="font-bold text-[#1E293B]">Dr. Rajashri Deshpande</p>
                         <p className="text-sm text-[#123B6D] font-semibold mt-1">Chief Editor</p>
                      </div>
                      <div className="bg-[#F8FAFC] border border-gray-100 rounded-xl px-6 py-5">
                         <p className="font-bold text-[#1E293B]">Dr. Arjun Lakhe</p>
                         <p className="text-sm text-[#123B6D] font-semibold mt-1">Co-Editor</p>
                      </div>
                      <div className="bg-[#F8FAFC] border border-gray-100 rounded-xl px-6 py-5">
                         <p className="font-bold text-[#1E293B]">Dr. Shayeree Ghosh</p>
                         <p className="text-sm text-[#123B6D] font-semibold mt-1">Associate Editor</p>
                      </div>
                      <div className="bg-[#F8FAFC] border border-gray-100 rounded-xl px-6 py-5">
                         <p className="font-bold text-[#1E293B]">Dr. Jyotika Chheda</p>
                         <p className="text-sm text-[#123B6D] font-semibold mt-1">Associate Editor</p>
                      </div>
                    </div>
                  </section>
                ...
                {activeTab === "journal-issues" && (
                  <section>
                    <div className="flex items-center gap-2 text-[#123B6D] font-bold text-lg mb-6">
                      <FileStack size={20} /> Volume and Issues
                    </div>
                    <div className="space-y-4">
                      {[
                        { vol: "Volume 5, Issue 2", date: "December 2024" },
                        { vol: "Volume 5, Issue 1", date: "June 2024" },
                        { vol: "Volume 4, Issue 2", date: "December 2023" },
                        { vol: "Volume 4, Issue 1", date: "June 2023" },
                      ].map((issue, idx) => (
                        <div key={idx} className="flex items-center justify-between bg-white border border-gray-200 hover:border-[#123B6D] transition-colors rounded-xl p-5 cursor-pointer group">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              <p className="font-bold text-gray-900 text-sm group-hover:text-[#123B6D]">
                                {issue.vol}
                              </p>
                ...
                {activeTab === "resources" && (
                  <section>
                    <div className="flex items-center gap-2 text-[#123B6D] font-bold text-lg mb-4">
                      <LinkIcon size={20} /> External Links & Templates
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <a href="#" className="flex flex-col gap-2 bg-gray-50 hover:bg-[#F8FAFC] border border-gray-200 hover:border-[#123B6D] transition-colors rounded-xl p-5 group">
                        <div className="flex items-center justify-between">
                          <div className="w-8 h-8 rounded bg-blue-100 text-blue-600 flex items-center justify-center"><Download size={16} /></div>
                          <ExternalLink size={16} className="text-gray-400 group-hover:text-[#123B6D]" />
                        </div>
                        <h4 className="font-bold text-[#1E293B] mt-2 group-hover:text-[#123B6D] transition-colors">Paper Submission Template</h4>
                        <p className="text-xs text-gray-500">Standard IEEE format DOCX template for manuscript submission.</p>
                      </a>
                      
                      <a href="#" className="flex flex-col gap-2 bg-gray-50 hover:bg-[#F8FAFC] border border-gray-200 hover:border-[#123B6D] transition-colors rounded-xl p-5 group">
                        <div className="flex items-center justify-between">
                          <div className="w-8 h-8 rounded bg-blue-100 text-blue-600 flex items-center justify-center"><LinkIcon size={16} /></div>
                          <ExternalLink size={16} className="text-gray-400 group-hover:text-[#123B6D]" />
                        </div>
                        <h4 className="font-bold text-[#1E293B] mt-2 group-hover:text-[#123B6D] transition-colors">UGC CARE List</h4>
                        <p className="text-xs text-gray-500">Link to the official UGC approved list of journals for reference.</p>
                      </a>
                    </div>
                  </section>
                )}
