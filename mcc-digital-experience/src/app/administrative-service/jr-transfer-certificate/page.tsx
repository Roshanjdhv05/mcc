              ...
              <div className="overflow-y-auto max-h-[70vh] bg-gray-100 p-4 md:p-8 flex justify-center">
                ...
                >
                  ...
                  <div className="text-center">
                    <h2 className="font-semibold text-[12px] mb-0.5 uppercase">JUNIOR COLLEGE</h2>
                  ...
                  <div>
                    ...
                    <div className="grid gap-1.5 ml-4" style={{gridTemplateColumns: '230px auto'}}>
                      ...
                      <div>LAST CLASS ATTENDED IN MCC</div>
                      <div>: <span className="uppercase">{formData.lastDegree || 'Last class attended in MCC'}</span></div>
