...
export default function TranscriptCertificatePage() {
  ...
  const handleDownload = async () => {
    try {
      ...
      pdf.save(`Transcript_Certificate_${formData.name.replace(/\s+/g, '_') || 'Student'}.pdf`);
    } catch (error) {
  ...
  const canDownload = !!(formData.name && formData.lastDegree && formData.placeOfApplication);
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          ...
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-indigo-500/20 border border-indigo-400/30 flex items-center justify-center">
              <FileText size={26} className="text-indigo-300" />
            </div>
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-white">Transcript Certificate</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12 -mt-8 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="bg-white rounded-3xl border border-[#E2E8F0] shadow-xl p-6 space-y-4">
              <div className="flex items-center gap-2 text-[#123B6D] font-bold text-base pb-2 border-b border-[#E2E8F0]">
                <GraduationCap size={18} /> Application Details
              </div>
              <div>
                <label className={labelCls}>Place of Application *</label>
                <input type="text" name="placeOfApplication" value={formData.placeOfApplication} onChange={handleChange} placeholder="Institute/Place/Country at which applying" className={inputCls} />
              </div>
            </div>
            ...
            <p className="text-xs text-center text-[#64748B]">Fill out Name, Last Degree and Place of Application to enable download.</p>
          </div>
          ...
          <div className="lg:col-span-7">
            <div className="bg-white rounded-3xl p-2 border border-[#E2E8F0] shadow-xl overflow-hidden sticky top-8">
              ...
              <div className="overflow-y-auto max-h-[70vh] bg-gray-100 p-4 md:p-8 flex justify-center">
                <div
                  id="printable-transcript-letter"
                  ref={letterRef}
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="font-bold underline text-[12px] mt-1">APPLICATION FOR TRANSCRIPT CERTIFICATE</h3>
                  </div>
                  ...
                  <div className="font-bold">Subject: Application for Transcript Certificate</div>
                  ...
                  <div className="indent-8 text-justify text-[10.5px]">
                    I, the undersigned, need transcripts for my application to higher education institutes/ visa/ international Jobs. Kindly Issue me the same. I have been made aware that my transcripts will be ready in around two weeks of time and I will have to come and collect it from the college for which I will receive an intimation from the college. Kindly issue me the same.
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid gap-1.5 ml-4" style={{gridTemplateColumns: '230px auto'}}>
                      ...
                      <div>: <span className="uppercase">{formData.lastDegree || (isJrCollege ? 'Last class attended in MCC' : 'Last completed degree from MCC')}</span></div>
                      ...
                      <div>THE PLACE OF APPLICATION</div>
                      <div>: <span className="uppercase">{formData.placeOfApplication || 'Institute/Place/Country at which applying'}</span></div>
                    </div>
                  </div>
                  ...
                  <div className="border-t border-gray-400 pt-3 text-[10.5px]">
                    ...
                    <p>1. Photocopies of all the marksheets of all the attempts of all the semesters of the degree for which the transcripts are needed.</p>
                    <p className="mb-2">2. A copy of photo ID proof / Student ID card of MCC.</p>

                    <p className="font-bold mb-1">Charges: INR 1000/- for a set of 5 copies. INR 100/- for each additional copy.</p>
