...
export const metadata: Metadata = {
  title: 'Library | MCC Digital Experience Platform',
  description: 'Mulund College of Commerce Library – Explore our vast collection of books, journals, and e-resources.',
};
