...
type StatusType = 'Current Student' | 'Alumnus' | '';
...
export default function DuplicateMarksheetPage() {
  ...
  const handleDownload = async () => {
    try {
      ...
      pdf.save(`Duplicate_Marksheet_${formData.name.replace(/\s+/g, '_') || 'Student'}.pdf`);
    } catch (error) {
  ...
  const isAlumnus = formData.status === 'Alumnus';
      ...
      <div className="bg-[#123B6D] pt-8 pb-16">
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          ...
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-rose-500/20 border border-rose-400/30 flex items-center justify-center">
              <FileText size={26} className="text-rose-300" />
            </div>
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-white">Duplicate Marksheet</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12 -mt-8 pb-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="bg-white rounded-3xl border border-[#E2E8F0] shadow-xl p-6 space-y-4">
              <div className="flex items-center gap-2 text-[#123B6D] font-bold text-base pb-2 border-b border-[#E2E8F0]">
                <Table size={18} /> Marksheets Needed
              </div>
              <p className="text-xs text-[#64748B] mb-2">Fill in the details for the specific marksheets you need.</p>
              ...
              <div className="overflow-y-auto max-h-[70vh] bg-gray-100 p-4 md:p-8 flex justify-center">
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="font-bold underline text-[12px] mt-1">APPLICATION FOR DUPLICATE MARKSHEET</h3>
                  </div>
                  ...
                  <div className="font-bold">Subject: Application for Duplicate Certificate</div>
                  ...
                  <div className="indent-8 text-justify text-[10.5px]">
                    I, the undersigned, need duplicate marksheet/marksheets (gradecards). I have lost my original marksheet/ grade-card and I have filed an FIR with the Police department. I also undertake to return the duplicate marksheets, if get my original marksheet/grade-cards. I have been made aware that my marksheet/grade-cards will be ready in around two weeks' time and I will have to come and collect it from the college. Kindly issue me the same.
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid gap-1 ml-4" style={{gridTemplateColumns: '185px auto'}}>
                      ...
                      <div className="font-bold bg-gray-200/50 underline px-1">: <span className="uppercase">{formData.status || 'Current Student/Alumnus'}</span></div>
                      ...
                      {isAlumnus ? (
                        <>
                          <div className="col-span-2 font-bold underline mt-1.5">ALUMNUS</div>
                          <div className="font-bold bg-gray-200/50 inline-block px-1">{isJrCollege ? 'CLASS' : 'DEGREE PROGRAMME'}</div>
                          <div className="font-bold bg-gray-200/50 underline px-1">: <span className="uppercase">{formData.degree || (isJrCollege ? 'CLASS' : 'DEGREE FOR WHICH THE DUPLICATES ARE NEEDED')}</span></div>
                        </>
                      ) : (
                        <>
                  ...
                  <div>
                    ...
                    <div className="mt-5">
                      <p>Sign:</p>
                      <p className="font-bold uppercase">{formData.name || '(NAME OF THE STUDENT/ALUMNUS)'}</p>
                      <p>({formData.phone || 'Phone No. of the Student/Alumnus'})</p>
                      <p>({formData.email || 'Email ID of the Student/Alumnus'})</p>
                    </div>
                  </div>
                  ...
                  <div className="border-t border-gray-400 pt-3 text-[10px]">
                    ...
                    <p>1. A copy of photo ID proof/ Student ID card of MCC. Photocopies of the marksheets, if you have.</p>
                    <p className="mb-2">2. Copy of the FIR filed.</p>

                    <p className="font-bold mb-1">Charges: INR 100 for each marksheet</p>
        ...
        <div className="bg-white rounded-3xl border border-[#E2E8F0] shadow-xl p-6 md:p-8 mb-8">
          <h2 className="text-xl font-bold text-[#123B6D] mb-3">About Duplicate Marksheet</h2>
          <p className="text-[#64748B] text-sm mb-4 leading-relaxed">
            Duplicate marksheets/grade-cards are issued only when the candidates have misplaced or lost them. The candidate must file a complaint with the local police station. It can also be done online: <a href="https://mumbaipolice.gov.in/OnlineComplaints?ps_id=0" target="_blank" rel="noopener noreferrer" className="text-rose-600 hover:underline">Mumbai Police Online Complaints</a>.
            <br/><br/>
            <span className="font-bold text-[#123B6D]">Charges:</span> INR 100 per marksheet/gradecard
          </p>
