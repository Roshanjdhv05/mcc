...
export const newFacultyData: Record<string, Record<string, FacultyMember[]>> = {
  ...
  'BCOM_BA': {
    'All': [
      { id: 'bcomba-1', name: 'Dr. Viji Kannan', image: '/Degree College Teachers/Viji Kannan.png', designation: 'COORDINATOR', role: 'Coordinator', qualification: 'BCS, MBA, NET, PhD', experience: '24 years', department: 'BCOM BA' },
