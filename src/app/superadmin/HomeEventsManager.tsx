...
import {
  ...
  CheckCircle, Clock, AlertTriangle, ChevronDown, ChevronUp, Eye, Plus, X, UploadCloud, Loader2, Filter
} from 'lucide-react';
...
export default function HomeEventsManager() {
  ...
  const handleRemoveFromHome = async (id: string) => {
    ...
    else { showMsg('success', 'Event archived.'); fetchEvents(); }
  };
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500">Manage events shown in the Event Gallery.</p>
        </div>
      ...
      {showUploadForm && (
        <div className="mb-8 bg-white p-6 rounded-2xl border border-[#E2E8F0] shadow-sm">
          <h3 className="text-lg font-bold text-gray-800 mb-4">Upload New Event</h3>
