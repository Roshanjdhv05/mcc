...
import {
  Users, Target, FileText, ChevronRight, Loader2, Info, Users2, FileArchive
} from "lucide-react";
            ...
            >
              ...
              <div className="p-6 md:p-10 space-y-10">
                {activeTab === "objective" && (
                  <section>
                    ...
                    <p className="text-gray-600 leading-relaxed text-base md:text-lg whitespace-pre-line">
                      Goals and primary objectives driving research within the institution.
                ...
                {activeTab === "committee" && (
                  <section>
                    <div className="flex items-center gap-2 text-[#123B6D] font-bold text-lg mb-4">
                      <Users2 size={20} /> Research Assessment, Promotion & Ethics Committee 2026-27
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {[
                        ...
                        >
                          ...
                          <p className="text-xs text-[#123B6D] font-semibold mt-0.5">
                            {member.role}
                          </p>
                        </div>
                      ))}
                ...
                {activeTab === "reports" && (
                  <section>
                    ...
                    <div className="space-y-4">
                      {[
                        { year: "2024-2025", title: "Annual Research Report" },
                        { year: "2023-2024", title: "Annual Research Report" },
                        { year: "2022-2023", title: "Annual Research Report" },
                      ].map((report, i) => (
                        <div
                          key={i}
                          className="flex items-center justify-between bg-white border border-gray-200 hover:border-[#123B6D] transition-colors rounded-xl p-5 cursor-pointer group"
                        >
                          ...
                          <ChevronRight
                            size={18}
                            className="text-gray-300 group-hover:text-[#123B6D]"
                          />
                        </div>
                      ))}
                    </div>
