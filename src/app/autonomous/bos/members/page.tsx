...
const bosData: BOSSection[] = [
  {
    ...
    members: [
      ...
      { numMembers: '',          nature: '',                                                                               name: 'Ms. Dhanvi Mehta' },
  ...
  },
  {
    ...
    label: 'Accountancy',
    members: [
      { numMembers: '1 MEMBER',  nature: 'Head of Department / Chairperson',                                              name: 'Mr. Nikhil Dilip Karkhanis' },
      { numMembers: '6 MEMBERS', nature: 'Names of Faculty',                                                              name: 'Ms. Riya Dhamapurkar' },
      { numMembers: '',          nature: '',                                                                               name: 'CA(Ms.) Snehal Chavan' },
      { numMembers: '',          nature: '',                                                                               name: 'Mr. Prathamesh Bobhate' },
      { numMembers: '',          nature: '',                                                                               name: 'Dr. Shweta Ghare' },
      { numMembers: '',          nature: '',                                                                               name: 'Ms. Suchitra Poojari' },
      { numMembers: '',          nature: '',                                                                               name: 'Mr. Pranav Panchal' },
  ...
  },
  {
    ...
    members: [
      ...
      { numMembers: '',          nature: '',                                                                               name: 'Ms. Gauri Atre' },
  ...
  },
  {
    ...
    label: 'English',
    members: [
      { numMembers: '1 MEMBER',   nature: 'Head of Department / Chairperson',                                              name: 'Dr. Shayeree Ghosh' },
      { numMembers: '9 MEMBERS',  nature: 'Names of Faculty',                                                              name: 'Mr. Jayanta Ghorpade' },
      { numMembers: '',           nature: '',                                                                               name: 'Mr. Nitin Lalsare' },
      { numMembers: '',           nature: '',                                                                               name: 'Ms. Vani Vaazirani' },
  ...
  },
  {
    ...
    members: [
      ...
      { numMembers: '',          nature: '',                                                                               name: 'Dr. Pooja Patil' },
  ...
  },
  {
    ...
    label: 'Mass Media',
    members: [
      { numMembers: '1 MEMBER',  nature: 'Head of Department / Chairperson',                                              name: 'Ms. Shriya Shenoy' },
      { numMembers: '6 MEMBERS', nature: 'Names of Faculty',                                                              name: 'Dr. Viji Kannan' },
      { numMembers: '',          nature: '',                                                                               name: 'Dr. Nimisha Gadkari' },
  ...
  },
  {
    ...
    members: [
      ...
      { numMembers: '5 MEMBERS', nature: 'Names of Faculty',                                                              name: 'Ms. Prajakta Khamkar' },
      { numMembers: '',          nature: '',                                                                               name: 'Ms. Shrushti Desai' },
      { numMembers: '',          nature: '',                                                                               name: 'Mr. Hari Kurup' },
      { numMembers: '',          nature: '',                                                                               name: 'Dr. Priti' },
      { numMembers: '',          nature: '',                                                                               name: 'Ms. Gauri Patil' },
      { numMembers: '2 MEMBERS', nature: 'Subject expert from outside Parent University (nominated by Academic Council)', name: 'Dr. Rahul Shah' },
      { numMembers: '',          nature: '',                                                                               name: 'Dr. Deepali Kamle' },
      { numMembers: '1 MEMBER',  nature: 'Nominated by VC from 6 recommended by college Principal',                      name: 'Dr. Arun Poojary' },
      { numMembers: '1 MEMBER',  nature: 'Representative of Industry / Corporate',                                        name: 'Mr. Parikshit Prabhudesai' },
      { numMembers: '1 MEMBER',  nature: 'PG Meritorious Alumnus nominated by Principal',                                 name: 'Mr. Pratik Chauhan' },
    ],
  },
  {
    id: 'iks',
          ...
          <div className="w-full lg:w-72 shrink-0">
            <div className="bg-white rounded-3xl border border-[#E2E8F0] shadow-sm p-4 lg:sticky lg:top-24">
                ...
                {bosData.map(s => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-3 px-4 py-3.5 rounded-2xl border-2 transition-all duration-200 text-left w-full
                        ${isActive
                    ...
                    >
                      ...
                      <span className={`font-semibold text-xs leading-tight whitespace-normal ${isActive ? 'text-[#123B6D]' : 'text-gray-600'}`}>
                        {s.label}
                      </span>
              ...
              <div 
                ...
                className="flex lg:hidden flex-row gap-2 overflow-x-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
                style={{ scrollBehavior: 'auto' }}
              >
                {[...bosData, ...bosData].map((s, idx) => {
                  const isActive = activeId === s.id;
                  return (
                    <button
                      key={`${s.id}-${idx}`}
                      onClick={() => setActiveId(s.id)}
                      className={`flex items-center gap-3 px-4 py-3.5 rounded-2xl border-2 transition-all duration-200 text-left shrink-0
                        ${isActive
                          ? 'bg-blue-50 border-blue-200 shadow-sm'
                          : 'bg-white border-transparent hover:bg-gray-50'
                        }`}
                    >
                      ...
                      <span className={`font-semibold text-xs leading-tight whitespace-nowrap ${isActive ? 'text-[#123B6D]' : 'text-gray-600'}`}>
                        {s.label}
                      </span>
                    </button>
                  );
