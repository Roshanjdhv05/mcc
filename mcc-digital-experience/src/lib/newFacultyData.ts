...
export const newFacultyData: Record<string, Record<string, FacultyMember[]>> = {
  'BCOM': {
    'Accountancy': [
      ...
      { id: 'bcom-acc-2', name: 'Dr. Riya Dhamapurkar', image: '/Degree College Teachers/Riya Dhamapurkar.jfif', email: 'riya.dhamapurkar@mccmulund.ac.in', designation: 'ASSISTANT PROFESSOR', qualification: 'M.Com, B.Ed., NET', experience: '16 years', researchInterest: 'Accountancy, Finance', department: 'Accountancy' },
      ...
      { id: 'bcom-acc-5', name: 'Ms. Suchitra Manjunath Poojari', image: '/Degree College Teachers/Suchitra Poojary.png', email: 'suchitra.poojari@mccmulund.ac.in', designation: 'ASSISTANT PROFESSOR', qualification: 'M.Com, NET, MH-SET, KSET', experience: '5 years', researchInterest: 'Financial Inclusion, Financial Literacy, Entrepreneurship, FinTech, Indian Knowledge Systems (IKS) in Finance', linkedin: 'https://www.linkedin.com/in/suchitra-poojari-0091b51bb', department: 'Accountancy' },
      { id: 'bcom-acc-6', name: 'Dr. Shweta Ghare', image: '/Degree College Teachers/Shweta Ghare.png', email: 'shweta.ghare@mccmulund.ac.in', designation: 'ASSISTANT PROFESSOR', qualification: 'M.Com, NET, SET, Ph. D., DEIM', experience: '9 years', corporateExp: '0 year', linkedin: '', department: 'Accountancy', researchInterest: 'Startups and Skill development' },
      { id: 'bcom-acc-7', name: 'Mr. Pranav Panchal', image: '/Degree College Teachers/Pranav Panchal.png', email: 'pranav.panchal@mccmulund.ac.in', designation: 'ASSISTANT PROFESSOR', qualification: 'M.Com ,NET', experience: '6 years', corporateExp: '3 year', linkedin: '', department: 'Accountancy', researchInterest: 'Finance, Accountancy,Commerce, Management' }

    ],
    'Mathematics and Statistics': [
      { id: 'bcom-math-1', name: 'Ms. Komal Bhatt', image: '/Degree College Teachers/Komal Bhatt.png', designation: 'ASSISTANT PROFESSOR', qualification: 'M.Sc. (Maths), M.Sc. (Statistics)', experience: '7 years', researchInterest: 'Applications of Mathematics & Statistics, Operations Research, Data Analytics, Decision-making and Education', linkedin: 'https://www.linkedin.com/in/komal-bhatt-555b47227', department: 'Mathematics and Statistics' },
  ...
  'BSC_IT': {
    'All': [
      ...
      { id: 'it-5', name: 'Dr. Sandhya Pandey', image: '/Degree College Teachers/Sandhya Pandey.jpeg', email: 'sandhya.pandey@mccmulund.ac.in', designation: 'ASSISTANT PROFESSOR', qualification: 'M.C.A., Ph.D., M.A.', experience: '18 years', corporateExp: '1 year', researchInterest: 'Web technology, Artificial intelligence', linkedin: 'https://www.linkedin.com/in/dr-sandhya-pandey-bab340197', department: 'B.Sc. IT' },
  ...
  'BAF': {
    'All': [
      { id: 'baf-5', name: 'Dr. Nitin Pawar', image: '/Degree College Teachers/Nitin Pawar.png', email: 'nitin.pawar@mccmulund.ac.in', designation: 'ASSISTANT PROFESSOR', role: 'Coordinator', qualification: 'M.Com, M.Phil, MBA (Finance), SET', experience: '16 years', researchInterest: 'Financial Analysis, Financial Planning, Banking', linkedin: 'https://www.linkedin.com/in/mr-nitin-pawar-3aa2863b3', department: 'BAF' },
  ...
  'BCOM_MS': {
    'All': [
      { id: 'bcomms-3', name: 'Dr. Kanchana Sattur', image: '/Degree College Teachers/Kanchana Sattur.png', email: 'kanchana.sattur@mccmulund.ac.in', designation: 'ASSISTANT PROFESSOR', role: 'Coordinator', qualification: 'M.Com (Buss. Mgmt), M.B.A. (Finance), NET (Com.), NET (Mgmt.), Ph.D', experience: '17 years', corporateExp: '2 years', researchInterest: 'Commerce, Management, Social Science', linkedin: 'https://www.linkedin.com/in/dr-kanchana-nayak-sattur-034a83185', department: 'BCOM MS' },
