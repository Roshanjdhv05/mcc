        ...
        <div className="flex md:hidden w-full overflow-hidden h-12 items-center"
          ...
          <div ref={tickerRef} className="flex items-center h-full whitespace-nowrap"
            ...
            {[...jrCollegeNav, ...jrCollegeNav, ...jrCollegeNav].map((item, i) => (
              <Link key={i} href={item.href || '#'}
                className={`flex-shrink-0 h-full flex items-center px-5 text-[11px] font-bold transition-colors uppercase whitespace-nowrap tracking-wider border-r border-white/10 ${item.active ? 'bg-[#008e59] text-white' : 'text-white/90 active:text-white active:bg-white/10'}`}
