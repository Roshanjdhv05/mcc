...
export default function CasteValidityPage() {
  const letterRef = useRef<HTMLDivElement>(null);
  const [isClient, setIsClient] = useState(false);
  const [formData, setFormData] = useState<FormData>({
    name: '', phone: '', email: '', caste: '', status: '', collegeType: '',
  ...
  const handleDownload = async () => {
    try {
      ...
      pdf.save(`CasteValidity_Application_${formData.name.replace(/\s+/g, '_') || 'Student'}.pdf`);
    } catch (error) {
    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <div className="bg-[#123B6D] pt-8 pb-16">
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-white">Caste Validity Certificate</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12 -mt-8 pb-16">
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="bg-white rounded-3xl border border-[#E2E8F0] shadow-xl p-6 space-y-4">
              ...
              <div>
                ...
                <input type="text" name="caste" value={formData.caste} onChange={handleChange} placeholder="Caste as per Government certificate" className={inputCls} />
              </div>
            </div>
                  ...
                  {formData.collegeType && (
                    <div>
                      <label className={labelCls}>
                        {isDegreeCollege ? (isAlumniOrDrop ? "Last completed/enrolled degree from MCC" : "Degree Programme Enrolled In") : (isAlumniOrDrop ? "Last Class Attended" : "Class")} *
                      </label>
                      {isDegreeCollege ? (
            ...
            <p className="text-xs text-center text-[#64748B]">Fill out Name, Caste and Status to enable download.</p>
          </div>
              ...
              <div className="overflow-y-auto max-h-[70vh] bg-gray-100 p-4 md:p-8 flex justify-center">
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="font-bold underline text-[12px] mt-1">APPLICATION FOR CASTE VALIDITY CERTIFICATE</h3>
                  </div>
                  ...
                  <div className="font-bold">Subject: Application for Caste Validity Certificate</div>
                  ...
                  <div className="indent-8 text-justify text-[10.5px]">
                    I, the undersigned, need a caste validity certificate. I pledge to not make any misuse/wrongful/deceitful use of the issued certificate for any unlawful gains or benefits. I understand that the college only verifies the caste based on the information furnished by the candidates during application or admission procedures. The decision about caste determination and validity by the authorised and competent government department prevails for all the purposes. I have been made aware that my caste validity certificate will be ready in around two weeks' time and I will have to collect it from college office, when it gets ready. Kindly issue me the same.
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid gap-1 ml-4" style={{gridTemplateColumns: '185px auto'}}>
                      <div>CASTE</div>
                      <div>: <span className="uppercase">{formData.caste || 'Caste as per Government certificate'}</span></div>
                  ...
                  <div className="mt-4 ml-4">
                    <span className="font-bold">The District Caste Certificate Scrutiny Committee: </span> Mention the District, where the certificate was issued.
                  </div>
                  ...
                  {/* Yours truly */}
                  <div>
                    <p>Yours truly, {isAlumniOrDrop ? 'ALUM/Drop year Student.' : ''}</p>
                    <div className="mt-5">
                      <p>Sign:</p>
        ...
        <div className="bg-white rounded-3xl border border-[#E2E8F0] shadow-xl p-6 md:p-8 mb-8">
          <h2 className="text-xl font-bold text-[#123B6D] mb-3">About Caste Validity Certificate</h2>
          <p className="text-[#64748B] text-sm mb-4 leading-relaxed">
            A caste validity certificate is issued on demand to the current students as well as alumnus. This certificate may be useful for the government authorities for verification purposes, or the candidates may need them for admission to any of the professional courses or recruitment examinations.
            <br/><br/>
            Kindly note this certificate only mentions the caste of the student/alumnus which is on record with the college as informed by the student during the application/admission and is not a substitute/alternative to the caste certificate issued by the competent and authorized government departments.
            <br/><br/>
