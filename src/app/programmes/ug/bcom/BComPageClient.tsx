...
const bcomFaculty = [
  ...
  { srNo: 7, name: 'Dr.Shivaji Pawar', additionalRole: 'Vice-Principal & Head', designation: 'Principal', department: 'Business Economics', education: 'M.A.,B.Ed.,M.Phil., Ph.D.,NET', email: 'shivaji.pawar@mccmulund.ac.in', teachingExp: '', image: '/Degree College Teachers/Shivaji Pawar.png' },
  ...
  { srNo: 18, name: 'Dr. Minal Mapuskar', additionalRole: 'Principal & head', designation: 'Principal', department: 'IKS', education: 'M.A,NET,SLET,PhD.', email: 'principal@mccmulund.ac.in', teachingExp: '20 yrs', image: '/Degree College Teachers/Minal Mapuskar.png' },
  ...
  { srNo: 20, name: 'Dr.Pramila D\'souza', additionalRole: 'Head & Assistant Professor', designation: 'Assistant Professor', department: 'Law', education: 'LLB., LLM., Ph.D., NET', email: 'pramiladsouza@mulund.ac.in', teachingExp: '0 yrs', image: "/Degree College Teachers/Pramila D'Souza.png" },
