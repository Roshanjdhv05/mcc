...
export default function ProgrammeEditor({ programme, isNew, onClose }: Props) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      cacheLog('INVALIDATED', 'mcc_programmes', 'edit action');
      qc.invalidateQueries({ queryKey: qk.allProgrammes() });
      qc.invalidateQueries({ queryKey: qk.programme(programme.slug) });
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-[#123B6D]/20 focus:border-[#123B6D] transition-all"
                      >
                        {(adminCode === 'B.COM' || adminCode === 'BCOM') ? (
                          <>
                            ...
                            <option value="English and Indian Languages">English and Indian Languages</option>
