...
import {
  Library, Users, GraduationCap, Award, FileText, ChevronRight, Loader2, Info, Building2, BookOpen
} from "lucide-react";
            ...
            >
              ...
              <div className="p-6 md:p-10 space-y-10">
                ...
                {activeTab === "recognition" && (
                  <section>
                    <div className="flex items-center gap-2 text-[#123B6D] font-bold text-lg mb-4">
                      <Building2 size={20} /> About the Centre
                    </div>
                    <p className="text-gray-600 leading-relaxed text-base md:text-lg whitespace-pre-line mb-8">
                      The Research Centre for PhD in Commerce specializes in Business Economics, fostering a culture of innovation and scholarly inquiry. Established in 2014, our center aims to contribute significantly to research and academic advancement.
                    </p>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="bg-[#F8FAFC] border border-gray-100 p-4 rounded-xl">
                        <div className="text-2xl font-bold text-[#1E293B]">2014</div>
                        <div className="text-xs font-semibold text-gray-500 uppercase mt-1">Established</div>
                      </div>
                      <div className="bg-[#F8FAFC] border border-gray-100 p-4 rounded-xl">
                        <div className="text-2xl font-bold text-[#1E293B]">2</div>
                        <div className="text-xs font-semibold text-gray-500 uppercase mt-1">Guides</div>
                      </div>
                      <div className="bg-[#F8FAFC] border border-gray-100 p-4 rounded-xl">
                        <div className="text-2xl font-bold text-[#1E293B]">11</div>
                      ...
                      <div className="bg-[#F8FAFC] border border-gray-100 p-4 rounded-xl">
                        ...
                        <div className="text-xs font-semibold text-gray-500 uppercase mt-1">PhD Awarded</div>
                      </div>
                    </div>
                  </section>
                )}
                ...
                {activeTab === "guides" && (
                  <section>
                    <div className="flex items-center gap-2 text-[#123B6D] font-bold text-lg mb-4">
                      <Users size={20} /> Authorized Research Guides
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="bg-[#F8FAFC] border border-gray-100 rounded-xl px-6 py-5 font-semibold text-[#1E293B] flex items-center gap-4">
                        <div className="w-10 h-10 rounded-full bg-[#123B6D]/10 text-[#123B6D] flex items-center justify-center">
                          <Users size={20} />
                        </div>
                        <span className="text-lg">Dr. Parvathi Venkatesh</span>
                      </div>
                      <div className="bg-[#F8FAFC] border border-gray-100 rounded-xl px-6 py-5 font-semibold text-[#1E293B] flex items-center gap-4">
                        <div className="w-10 h-10 rounded-full bg-[#123B6D]/10 text-[#123B6D] flex items-center justify-center">
                          <Users size={20} />
                        </div>
                        <span className="text-lg">Dr. Shivaji Pawar</span>
                      </div>
                    </div>
                  </section>
                )}
                    ...
                    <div className="overflow-x-auto border border-gray-100 rounded-xl">
                      <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-gray-100 text-[14px]">
                          {students
                            .filter(s => activeTab === "thesis" ? s.status !== "Work in Progress" : true)
                            .map((student, idx) => (
                ...
                {activeTab === "application" && (
                  <section>
                    <div className="flex items-center gap-2 text-[#123B6D] font-bold text-lg mb-4">
                      <Info size={20} /> Application Process
                    </div>
                    <div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
                      <p className="text-gray-600 leading-relaxed">
                        To apply for a PhD program at the Research Centre, candidates must follow the University of Mumbai guidelines.
                        Please ensure you have cleared PET or hold an M.Phil/NET/SET qualification.
                      </p>
                      <ul className="mt-4 space-y-3 text-gray-600">
                        <li className="flex items-start gap-3">
                          ...
                          <span>Check eligibility according to university standards.</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <div className="w-6 h-6 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center shrink-0 mt-0.5">
                            <span className="text-sm font-bold">2</span>
                          </div>
                          <span>Prepare a preliminary research proposal.</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <div className="w-6 h-6 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center shrink-0 mt-0.5">
                            <span className="text-sm font-bold">3</span>
                          </div>
                          <span>Submit the application form along with required documents to the center.</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <div className="w-6 h-6 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center shrink-0 mt-0.5">
                            <span className="text-sm font-bold">4</span>
                          </div>
                          <span>Attend the interview/presentation session scheduled by the committee.</span>
                        </li>
                      </ul>
                    </div>
                  </section>
