...
const courses: Course[] = [
  ...
  // Post Graduate
  {
    code: 'MCom-AA',
    name: 'M.Com.',
    fullName: 'M.Com. (Advanced Accountancy)',
    level: 'Post Graduate',
    duration: '2 Years', seats: 60,
    tags: ['Accountancy', 'Commerce', 'Finance'],
  ...
  },
  {
    code: 'MCom-BM',
    name: 'M.Com.',
    fullName: 'M.Com. (Business Management)',
    level: 'Post Graduate',
    duration: '2 Years', seats: 60,
    tags: ['Management', 'Commerce', 'Business'],
  ...
  },
  {
    code: 'MCom-BF',
    name: 'M.Com.',
    fullName: 'M.Com. (Banking & Finance)',
    level: 'Post Graduate',
    duration: '2 Years', seats: 60,
    tags: ['Banking', 'Finance', 'Commerce'],
  ...
  },
  {
    code: 'MSc-IT',
    name: 'M.Sc. IT',
    fullName: 'M.Sc. (Information Technology)',
    level: 'Post Graduate',
    duration: '2 Years', seats: 60,
    tags: ['Technology', 'IT', 'Science'],
  ...
  },
  {
    code: 'MSc-Finance',
    name: 'M.Sc.',
    fullName: 'M.Sc. (Finance)',
    level: 'Post Graduate',
    duration: '2 Years', seats: 60,
    tags: ['Finance', 'Markets', 'Science'],
