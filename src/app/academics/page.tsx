...
const programmes = [
  {
    ...
    color: 'from-blue-600 to-blue-800', href: '/academics/fyjc',
  },
  {
    ...
    color: 'from-indigo-600 to-indigo-800', href: '/academics/syjc',
  },
  {
    ...
    color: 'from-[#123B6D] to-[#00254e]', href: '/academics/bcom',
  },
  {
    ...
    color: 'from-teal-600 to-teal-800', href: '/academics/mcom',
  },
  {
    ...
    color: 'from-purple-600 to-purple-800', href: '/academics/mscit',
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12 -mt-10 pb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {programmes.map((p) => (
            <div
              key={p.code}
              className="group bg-white rounded-2xl border border-[#E2E8F0] shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all overflow-hidden"
            >
