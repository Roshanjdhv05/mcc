...
const bmsFaculty = [
  { srNo: 1, name: 'Dr. Kanchana Sattur', additionalRole: 'HOD & Coordinator', designation: 'Assistant Professor', department: 'Bachelor of Commerce (Management Studies)', education: 'MCom, M.B.A, NET(Comm& Mgmt), PhD.,', email: 'kanchana.sattur@mccmulund.ac.in', teachingExp: '15 yrs', image: '/Degree College Teachers/Kanchana Sattur.png' },
