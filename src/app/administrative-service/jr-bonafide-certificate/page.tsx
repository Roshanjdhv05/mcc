...
export default function BonafideCertificatePage() {
  ...
  const handleDownload = async () => {
    try {
      ...
      // --- Mobile fix: temporarily force A4 pixel width so capture is always correct ---
      // A4 at 96dpi ≈ 794px wide. We override any responsive shrinkage before capturing.
  ...
  const isJrCollege = true;
  const isDegreeCollege = false;
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12 -mt-8 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-7 print:w-full print:m-0 print:p-0">
            <div className="bg-white rounded-3xl p-2 border border-[#E2E8F0] shadow-xl overflow-hidden sticky top-8 print:border-none print:shadow-none print:static">
              ...
              {/* On mobile: horizontal scroll so letter isn't squished; on desktop: normal centred layout */}
              <div className="overflow-y-auto max-h-[70vh] bg-gray-100 p-4 md:p-8 flex justify-center print-hide-overflow print:bg-white print:p-0 overflow-x-auto">
                {/* A4 Paper container – always at least 210mm wide so mobile can scroll to see full letter */}
                <div 
                  id="printable-letter"
                  ref={letterRef}
                  className="bg-white shadow-sm text-black font-serif text-[11.5px] leading-normal flex flex-col flex-shrink-0"
                  style={{
                ...
                >
                  ...
                  <div className="text-center">
                    <h2 className="font-semibold text-[12px] mb-0.5">JUNIOR COLLEGE</h2>
                  ...
                  <div>
                    ...
                    <div className="grid gap-1 ml-4" style={{gridTemplateColumns: '185px auto'}}>
                      ...
                      <div>: <span className="uppercase">{formData.status || 'Current Student/Alumnus/Drop Year Student'}</span></div>
                          ...
                          <div>: <span className="uppercase">JUNIOR COLLEGE</span></div>
                  ...
                  <div className="border-t border-gray-400 pt-3 text-[10.5px]">
                    ...
                    <p className="font-bold mb-1">Charges: INR 50/-</p>
        ...
        <div className="bg-white rounded-3xl border border-[#E2E8F0] shadow-xl p-6 md:p-8 mt-8 mb-8">
          ...
          <p className="text-[#64748B] text-sm mb-4 leading-relaxed">
            ...
            <br/><br/>
            <span className="font-bold text-[#123B6D]">Charges:</span> INR 50/-
          </p>
