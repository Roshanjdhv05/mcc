...
import {
  Trophy, Activity, Award, ChevronRight, Loader2, Info, Star, Calendar, Users
} from "lucide-react";
...
function CompetitionsContent() {
  ...
  const handleSelect = (id: string) => {
    ...
    router.push(`/research/competitions?tab=${id}`, { scroll: false });
  };
            ...
            >
              ...
              <div className="p-6 md:p-10 space-y-10">
                ...
                {activeTab === "avishkar" && (
                  <section>
                    <div className="flex items-center gap-2 text-[#123B6D] font-bold text-lg mb-4">
                      <Trophy size={20} /> About Avishkar
                    </div>
                    <p className="text-gray-600 leading-relaxed text-base md:text-lg whitespace-pre-line mb-8">
                      Initiated by the Honorable Governor of Maharashtra, Avishkar is a premier research convention designed to develop a research culture and scientific temper among students. Students from UG, PG, and PhD levels present their innovative ideas and projects at this prestigious university-level competition.
                    </p>
                    
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      <div className="bg-[#F8FAFC] border border-gray-100 p-5 rounded-xl">
                        <Users size={24} className="text-[#123B6D] mb-2" />
                        <div className="font-bold text-[#1E293B]">Open For</div>
                        <div className="text-sm text-gray-500 mt-1">UG, PG, Post-PG & PhD Students</div>
                      </div>
                      <div className="bg-[#F8FAFC] border border-gray-100 p-5 rounded-xl">
                        <Calendar size={24} className="text-[#123B6D] mb-2" />
                        <div className="font-bold text-[#1E293B]">Frequency</div>
                        <div className="text-sm text-gray-500 mt-1">Annual Event</div>
                      </div>
                      <div className="bg-[#F8FAFC] border border-gray-100 p-5 rounded-xl">
                        <Award size={24} className="text-[#123B6D] mb-2" />
                        <div className="font-bold text-[#1E293B]">Level</div>
                        <div className="text-sm text-gray-500 mt-1">University & State Level</div>
                      </div>
                    </div>
                  </section>
                )}
                ...
                {activeTab === "shodh" && (
                  <section>
                    <div className="flex items-center gap-2 text-[#123B6D] font-bold text-lg mb-4">
                      <Activity size={20} /> Inter-collegiate Research Competition
                    </div>
                    <p className="text-gray-600 leading-relaxed text-base md:text-lg whitespace-pre-line mb-8">
                      Shodh is an inter-collegiate research competition that provides a platform for budding researchers to showcase their talents. It encourages students from various disciplines across colleges to present their original research, engage in academic discourse, and receive valuable feedback from experts in the field.
                    </p>
                    <div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
                       <h4 className="font-bold text-[#1E293B] mb-3">Key Highlights</h4>
                       <ul className="space-y-3 text-gray-600">
                         <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-[#D4A017]" /> Cross-disciplinary project presentations</li>
                         <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-[#D4A017]" /> Expert jury panel from academia and industry</li>
                         <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 rounded-full bg-[#D4A017]" /> Cash prizes and certificates for winners</li>
                       </ul>
                    </div>
                  </section>
                )}
                ...
                {activeTab === "conclave" && (
                  <section>
                    <div className="flex items-center gap-2 text-[#123B6D] font-bold text-lg mb-4">
                      <Award size={20} /> PTVA's Inter-institutional Conclave
                    </div>
                    <p className="text-gray-600 leading-relaxed text-base md:text-lg whitespace-pre-line mb-8">
                      An exclusive conclave bringing together researchers, faculties, and students from all PTVA sister institutions. The event focuses on collaborative research, addressing contemporary socio-economic challenges, and fostering a strong intra-institutional research network.
                    </p>
                    <div className="bg-[#123B6D] text-white rounded-xl p-6 relative overflow-hidden">
                      <div className="absolute top-0 right-0 opacity-10">
                        <Award size={120} className="transform translate-x-4 -translate-y-4" />
                      </div>
                      <div className="relative z-10">
                        ...
                        <button className="bg-white text-[#123B6D] font-bold px-4 py-2 rounded-lg text-sm hover:bg-gray-100 transition-colors">
