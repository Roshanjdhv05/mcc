  ...
  return (
    <div className="bg-[#F8FAFC] min-h-screen pt-12 pb-24">
      <div className="max-w-7xl mx-auto px-4 md:px-12">
        <h1 className="text-4xl md:text-5xl font-bold text-[#123B6D] font-[var(--font-heading)] mb-6">Under Graduate</h1>
        <p className="text-lg text-[#64748B] mb-12 max-w-3xl">
          Explore our undergraduate degree programmes. MCC offers B.Com, B.Sc. IT, BMS, and various other specialised bachelors degrees to build your career.
        </p>
