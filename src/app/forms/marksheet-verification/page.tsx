...
export default function MarksheetVerificationPage() {
  ...
  const handleDownload = async () => {
    try {
      ...
      pdf.save(`Marksheet_Verification_${formData.name.replace(/\s+/g, '_') || 'Student'}.pdf`);
    } catch (error) {
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          ...
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-cyan-500/20 border border-cyan-400/30 flex items-center justify-center">
              <FileText size={26} className="text-cyan-300" />
            </div>
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-white">Marksheet Verification</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12 -mt-8 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="bg-white rounded-3xl border border-[#E2E8F0] shadow-xl p-6 space-y-4">
              <div className="flex items-center gap-2 text-[#123B6D] font-bold text-base pb-2 border-b border-[#E2E8F0]">
                <Table size={18} /> Marksheets for Verification
              </div>
              <p className="text-xs text-[#64748B] mb-2">Fill in the details for the specific marksheets to be verified.</p>
          ...
          <div className="lg:col-span-7">
            <div className="bg-white rounded-3xl p-2 border border-[#E2E8F0] shadow-xl overflow-hidden sticky top-8">
              ...
              <div className="overflow-y-auto max-h-[70vh] bg-gray-100 p-4 md:p-8 flex justify-center">
                <div
                  id="printable-verification-letter"
                  ref={letterRef}
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="font-bold underline text-[12px] mt-1">APPLICATION FOR MARKSHEET VERIFICATION</h3>
                  </div>
                  ...
                  <div className="font-bold">Subject: Application for Marksheet Verification</div>
                  ...
                  <div className="indent-8 text-justify text-[10.5px]">
                    I, the undersigned, need verification of my marksheets/gradecards. I have been made aware that my marksheet verification report will be completed in around two weeks' time and I will have to come and collect it from the college on a working day. Kindly issue me the same.
                  </div>
                    ...
                    <div className="grid gap-1 ml-4" style={{gridTemplateColumns: '185px auto'}}>
                      ...
                      {isAlumni ? (
                        <>
                          ...
                          <div className="font-bold bg-gray-200/50 underline px-1">: <span className="uppercase">{formData.degree || (isJrCollege ? 'CLASS' : 'DEGREE FOR WHICH THE VERIFICATION IS NEEDED')}</span></div>
                        </>
                      ) : (
                        <>
                  ...
                  <div className="border-t border-gray-400 pt-3 text-[10px]">
                    ...
                    <p className="mb-2">1. A copy of photo ID proof/ Student ID card of MCC. Photocopies of the marksheets/grade-cards.</p>

                    <p className="font-bold mb-1">Charges: INR 100 per marksheet</p>
