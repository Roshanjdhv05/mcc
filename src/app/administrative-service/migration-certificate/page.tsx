...
export default function MigrationCertificatePage() {
  ...
  const handleDownload = async () => {
    try {
      ...
      pdf.save(`Migration_Certificate_${formData.name.replace(/\s+/g, '_') || 'Student'}.pdf`);
    } catch (error) {
      ...
      <div className="bg-[#123B6D] pt-8 pb-16">
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          ...
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-purple-500/20 border border-purple-400/30 flex items-center justify-center">
              <FileText size={26} className="text-purple-300" />
            </div>
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-white">Migration Certificate</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12 -mt-8 pb-16">
            ...
            <div className="bg-white rounded-3xl p-2 border border-[#E2E8F0] shadow-xl overflow-hidden sticky top-8">
              ...
              <div className="overflow-y-auto max-h-[70vh] bg-gray-100 p-4 md:p-8 flex justify-center">
                ...
                >
                  ...
                  <div className="font-bold">Subject: Application for Migration Certificate</div>
                  ...
                  <div className="indent-8 text-justify text-[10.5px]">
                    I, the undersigned, need a Migration certificate. Kindly Issue me the same. I have been made aware that my migration certificate will be directly send to my current institute of enrolment.
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid gap-1.5 ml-4" style={{gridTemplateColumns: '230px auto'}}>
                      ...
                      <div>: <span className="uppercase">{formData.newProgramme || 'New degree in which enrolled'}</span></div>
        ...
        <div className="bg-white rounded-3xl border border-[#E2E8F0] shadow-xl p-6 md:p-8 mb-8">
          ...
          <p className="text-[#64748B] text-sm mb-4 leading-relaxed">
            ...
            <br/><br/>
            For Transfer Certificate - <a href="/administrative-service/transfer-certificate" className="text-purple-600 hover:underline">Click here</a>
            <br/>
