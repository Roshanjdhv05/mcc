...
import { GraduationCap, Download, X, ChevronLeft } from 'lucide-react';

const autonomyNav = [
  { label: 'Conferment of Autonomy (Certificate)', href: '/autonomous/Conferment-of-Autonomy', active: true },
  { label: 'Board of Studies', href: '#', active: false },
  { label: 'Academic Council', href: '#', active: false },
  { label: 'Finance Committee', href: '#', active: false },
  { label: 'Governing Body', href: '#', active: false },
];

export default function ConfermentOfAutonomyPage() {
    ...
    <div className="bg-[#F8FAFC] min-h-screen pb-12 font-sans">
      ...
      <div className="relative py-10 flex flex-col items-center text-center overflow-hidden">
        ...
        <div className="inline-flex items-center gap-2 bg-[#123B6D]/10 border border-[#123B6D]/20 text-[#123B6D] px-4 py-1.5 rounded-full text-xs font-bold mb-4 uppercase tracking-widest">
          <GraduationCap size={13} /> Autonomous Status
        </div>
        ...
        <p className="text-gray-500 text-sm max-w-xl px-4 mb-6">
          Official certificate granting autonomous status to Mulund College of Commerce.
        </p>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <ChevronLeft size={16} /> Back to Autonomous
          </Link>
          <a
            href="/Conferment of Autonomy (Grant of Autonomy).pdf"
            download
      ...
      <div className="max-w-5xl mx-auto px-4 lg:px-8">
        <div className="bg-white rounded-2xl shadow-md border border-[#E2E8F0] overflow-hidden" style={{ height: '80vh' }}>
          {!pdfError ? (
            <iframe
              src="/Conferment of Autonomy (Grant of Autonomy).pdf#view=FitH&toolbar=1&navpanes=0"
              className="w-full h-full border-none"
              title="Conferment of Autonomy Certificate"
