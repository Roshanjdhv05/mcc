...
const bcomFaculty = [
  ...
  { srNo: 22, name: 'Ms.Komal Bhatt', additionalRole: '—', designation: 'Assistant Professor', department: 'Mathematics, Statistics and Computer Applications', education: 'M.Sc. (Maths), M.Sc. (Statistics)', email: 'komal.bhat@mccmulund.ac.in', teachingExp: '0 yrs', image: '/Degree College Teachers/Komal Bhatt.png' },
