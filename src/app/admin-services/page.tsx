...
import { Users, ChevronRight, GraduationCap, Building2, Train, FileText, ArrowRightLeft, Globe, Shield, CheckCircle, BookOpen, Copy, Award, Stamp } from 'lucide-react';

const grantsInAidStaff = [
  { sr: 1, name: '—', designation: '—' },
];
...
const degreeServices = [
  { icon: Train,         label: 'Railway Concession',       desc: 'Local train season pass concession for degree college students.' },
  { icon: FileText,      label: 'Bonafide Certificate',      desc: 'Proof of enrollment at Mulund College of Commerce.' },
  { icon: ArrowRightLeft,label: 'Transfer Certificate',      desc: 'For progression to other HEI of University of Mumbai.' },
  { icon: Globe,         label: 'Migration Certificate',     desc: 'For progression to another University.' },
  { icon: FileText,      label: 'Transcript',                desc: 'For Foreign Universities or Employment purposes.' },
  { icon: Shield,        label: 'Character Certificate',     desc: 'Required for Government Employments.' },
  { icon: CheckCircle,   label: 'Marksheet Verification',   desc: 'Official verification of mark sheets issued by the college.' },
  { icon: Stamp,         label: 'Caste Validity Verification', desc: 'Verification for caste certificate validity.' },
  { icon: Award,         label: 'Scholarship & Free-ship',  desc: 'Apply for government and institutional scholarship schemes.' },
...
const juniorCollegeServices = [
  { icon: Train,         label: 'Railway Concession',       desc: 'Local train season pass concession for junior college students.' },
  { icon: BookOpen,      label: 'Leaving Certificate',      desc: 'Issued on departure from junior college.' },
  { icon: FileText,      label: 'Bonafide Certificate',     desc: 'Proof of enrollment at the junior college.' },
  { icon: Globe,         label: 'Migration Certificate',    desc: 'For students moving to another Board / institution.' },
  { icon: Stamp,         label: 'Caste Validity Verification', desc: 'Verification for caste certificate validity.' },
  { icon: Award,         label: 'Scholarship & Free-ship',  desc: 'Apply for government and institutional scholarship schemes.' },
  { icon: Copy,          label: 'Duplicate Marksheet',      desc: 'Request a duplicate mark sheet in case of loss or damage.' },
];
      ...
      <div className="bg-[#123B6D] pt-10 pb-20">
        <div className="max-w-7xl mx-auto px-4 md:px-12">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-white/70 text-sm font-medium uppercase tracking-widest">Student Services</span>
          </div>
          <h1 className="text-3xl md:text-4xl font-bold text-white font-[var(--font-heading)] mb-2">
            Administrative Services
          </h1>
          <p className="text-white/60 max-w-xl">
            Access certificates, concessions, verifications and other administrative services offered by Mulund College of Commerce.
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-[#E2E8F0]">
            ...
            <div>
              <div className="px-6 py-4 bg-[#123B6D]/5 border-b border-[#E2E8F0]">
                <h3 className="font-bold text-[#123B6D] text-sm uppercase tracking-wide">Grants-in-Aid Section</h3>
              </div>
            ...
            <div>
              <div className="px-6 py-4 bg-[#D4A017]/5 border-b border-[#E2E8F0]">
                <h3 className="font-bold text-[#D4A017] text-sm uppercase tracking-wide">Self-Finance Section</h3>
              </div>
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-gray-50 border-b border-[#E2E8F0]">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm transition-all ${
                activeTab === 'degree'
                  ...
                  : 'bg-white border border-[#E2E8F0] text-gray-600 hover:border-[#123B6D]/30'
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm transition-all ${
                activeTab === 'junior'
                  ...
                  : 'bg-white border border-[#E2E8F0] text-gray-600 hover:border-[#D4A017]/30'
              }`}
            >
              <BookOpen size={18} />
              Junior College
          ...
          {activeTab === 'degree' && (
            <div>
              <div className="flex items-center gap-3 mb-5">
                ...
                <h2 className="text-xl font-bold text-[#123B6D] font-[var(--font-heading)]">Degree College Services</h2>
              </div>
          ...
          {activeTab === 'junior' && (
            <div>
              <div className="flex items-center gap-3 mb-5">
                ...
                <h2 className="text-xl font-bold text-[#D4A017] font-[var(--font-heading)]">Junior College Services</h2>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
