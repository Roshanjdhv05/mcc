...
export const newFacultyData: Record<string, Record<string, FacultyMember[]>> = {
  'BCOM': {
    'Accountancy': [
      ...
      { id: 'bcom-acc-2', name: 'Ms. Riya Dhamapurkar', email: 'riya.dhamapurkar@mccmulund.ac.in', designation: 'ASSISTANT PROFESSOR', qualification: 'M.Com, B.Ed., NET', experience: '16 years', researchInterest: 'Accountancy, Finance', department: 'Accountancy' },
    ...
    'Commerce': [
      { id: 'bcom-com-1', name: 'CA Dr. Anuradha Ganesh', email: 'anuradha.ganesh@mccmulund.ac.in', designation: 'ASSISTANT PROFESSOR', qualification: 'M.Com, C.A., PhD', experience: '23 years', corporateExp: '9 years', researchInterest: 'Finance, Marketing, Behavioural finance', department: 'Commerce' },
    ...
    'IKS': [
      { id: 'bcom-iks-1', name: 'Dr. Minal Mapuskar', image: '/Degree College Teachers/Minal Mapuskar.png', email: 'principal@mccmulund.ac.in', designation: 'PRINCIPAL & HEAD', qualification: 'M.A, NET, SLET, PhD.', experience: '20 yrs', department: 'IKS' },
      { id: 'bcom-iks-2', name: 'Ms. Jui Kadvwekar', image: '/Degree College Teachers/Jui Kudvekar.png', email: 'juikadvekar@gmail.com', designation: 'ASSISTANT PROFESSOR', qualification: 'MA., NET', department: 'IKS' }
    ],
    'Law': [
      { id: 'bcom-law-1', name: "Dr. Pramila D'souza", image: "/Degree College Teachers/Pramila D'Souza.png", email: 'pramiladsouza@mulund.ac.in', designation: 'HEAD & ASSISTANT PROFESSOR', qualification: 'LLB., LLM., Ph.D., NET', department: 'Law' }
    ],
    'Business Economics': [
