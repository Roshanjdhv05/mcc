...
export default function TransferCertificatePage() {
  ...
  const [formData, setFormData] = useState<FormData>({
    name: '', phone: '', email: '', collegeType: 'Degree College',
              ...
              <div className="space-y-4">
                <div>
                  <label className={labelCls}>
                    Last Completed Degree from MCC *
                  </label>
              ...
              <div className="overflow-y-auto max-h-[70vh] bg-gray-100 p-4 md:p-8 flex justify-center">
                ...
                >
                  ...
                  <div className="border-t border-gray-400 pt-3 text-[10.5px]">
                    ...
                    <p>1. The form/request letter/fee-receipt/allotment letter from the other institute giving the admission which demands the transfer certificate.</p>
                    <p className="mb-2">2. Photocopy of all the marksheets of all the semester of the last degree earned at this college.</p>
