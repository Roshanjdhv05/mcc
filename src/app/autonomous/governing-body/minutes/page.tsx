...
import { FileText, Eye, ChevronRight, Download, Users } from 'lucide-react';
...
const bodyData = {
  ...
  data: {
    '2021-22': [
      '01-11-2021.pdf',
      '27-04-2022.pdf',
      'UG & PG PROGM OFFERED. 01-11-2021.pdf'
    ],
    '2022-23': [
      '12-11-2022.pdf',
      '30-05-2023.pdf'
    ...
    '2023-24': [
      '08-11-2023.pdf',
      '15-04-2024 GOVERNING BODY MEETING.pdf',
      '15-04-2024.pdf',
      '19-04-2024 GBM ATTENDENCE SHEET.pdf',
      '19-04-2024 GOVERNING BODY MEETING.pdf',
      'UNIVERSITY GRANTS COMMISSION 15-04-2024.pdf'
    ],
    '2024-25': [
      '10-12-2024.pdf',
      '25-04-2025.pdf',
...
export default function GoverningBodyMinutesPage() {
  ...
  const getPdfUrl = (year: string, filename: string) => {
    return `/GOVERNING BODY/${year}/${filename}`;
  };
    ...
    <div className="bg-[#F8FAFC] min-h-screen">
      ...
      <div className="bg-[#123B6D] pt-24 pb-16 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute -left-20 top-40 w-72 h-72 bg-[#3B82F6] rounded-full blur-3xl" />
        </div>
        <div className="max-w-7xl mx-auto px-4 md:px-12 relative z-10 text-center">
          ...
          <p className="text-white/80 max-w-2xl mx-auto text-sm md:text-base leading-relaxed">
            Archive of official minutes and reports from the Governing Body meetings.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            <h2 className="text-2xl font-bold text-[#123B6D] font-[var(--font-heading)] flex items-center gap-3">
              <bodyData.icon className="text-[#3B82F6]" size={28} />
              Meeting Archives
            </h2>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2 shrink-0 ml-4">
                            <button className="flex items-center gap-1 text-xs font-semibold text-[#123B6D] hover:text-[#3B82F6] transition-colors p-1.5 rounded bg-gray-100 hover:bg-gray-200">
                              <Eye size={14} /> Preview
                            </button>
                            <a 
                              href={fileUrl}
